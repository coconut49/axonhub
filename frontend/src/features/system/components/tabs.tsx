...
export function SystemSettingsTabs({ initialTab }: SystemSettingsTabsProps) {
  ...
  return (
    ...
    >
      <TabsList
        ref={setTabListRef}
        className='shadow-soft border-border bg-background flex w-full justify-start overflow-x-auto rounded-2xl border sm:w-fit sm:max-w-full [&_[data-slot=tabs-trigger]]:flex-none [&_[data-slot=tabs-trigger]]:shrink-0'
      >
